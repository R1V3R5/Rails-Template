...
when "4"
  ...
  when "0"
    ...
    prefs[:apps4] = multiple_choice "Build a starter application?",
      ...
      ["R1V3R5 tailored application", "r1v3r5"],
    ...
    case prefs[:apps4]
      ...
      when 'r1v3r5'
        prefs[:apps4] = prefs[:r1v3r5_custom] || (multiple_choice "Testing",
        [["Bootstrapped Basic Theme", "r1v3r5-bootstrap"]])
    end
  end
end
...
if prefer :apps4, 'r1v3r5-bootstrap'
  prefs[:authentication] = 'devise'
  prefs[:authorization] = false
  prefs[:ban_spiders] = true
  prefs[:better_errors] = true
  prefs[:database] = 'mysql2'
  prefs[:deployment] = 'none'
  prefs[:devise_modules] = false
  ...
  add_gem 'mysql2', :group => :development
  add_gem 'jquery-ui-rails'
  add_gem 'responders'
  add_gem "nested_form"
  add_gem 'faker'
  add_gem 'meta_request', "~> 0.3.0"
  after_bundler do 
  ...
  stage_three do
    ...
    copy_from_repo 'app/controllers/welcome_controller.rb', :repo => repo
    ...
    copy_from_repo 'app/views/layouts/_navbar.html.haml', :repo => repo
    copy_from_repo 'app/views/welcome/index.html.haml', :repo => repo
    # create navigation links using the rails_layout gem
    # generate 'layout:navigation -f'
    ...
    copy_from_repo 'vendor/assets/javascripts/bootstrap.js', :repo => repo
    copy_from_repo 'vendor/assets/javascripts/underscore.js', :repo => repo
    copy_from_repo 'vendor/assets/stylesheets/bootstrap.css', :repo => repo
    copy_from_repo 'vendor/assets/stylesheets/bootstrap-theme.css', :repo => repo
